...
| <a name="input_enable_nat_gateway"></a> [enable\_nat\_gateway](#input\_enable\_nat\_gateway) | A boolean flag to enable/disable NAT Gateways for the private subnets | `bool` | `true` | no |
